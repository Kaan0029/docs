...
1. **Ship Imagery**  
   Fine-tuned Stable Diffusion (like ShipSense) to generate synthetic satellite images of fishing vessels

2. **Predictive Migration Modeling**  
   Modeling how fish populations respond to fishing pressure in poorly monitored regions
